...
| تشغيل ذاتي بسيط | Dokploy يدير Docker Compose على خادم داخلي واحد محدود المنافذ | ADR-023 |
...
| البنية | Laravel Modular Monolith + React موحّد + MySQL وValkey ضمن Docker Compose | R1 |
| التشغيل | خادم داخلي واحد يديره Dokploy، مع جدار ناري ونسخ خارج الخادم | R1 |
...
- تشغيل داخلي عبر Dokploy مع منافذ مقيدة، وقبول خطر توقف الخدمة عند تعطل الخادم الواحد.
