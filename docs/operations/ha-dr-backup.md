...
يعمل المنتج على خادم داخلي واحد عبر Dokploy وDocker Compose. لا توجد HA على مستوى المضيف؛ فشل الخادم يوقف الخدمة إلى أن يُستعاد الهدف أو تُنقل الحزمة إلى هدف بديل. تقتصر الحماية داخل الخادم على healthchecks وشبكات Docker الداخلية ومراقبة السعة. لا يعامل Valkey أو الفهرس كنسخة وحيدة من بيانات الأعمال.

## النسخ والاحتفاظ

- تلتقط مهمة Compose نسخاً كاملة وincremental أو binlog بما يتيح PITR ضمن RPO.
