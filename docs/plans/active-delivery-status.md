...
| 2026-07-18 | صفحة دخول W1.1 وفق نظام التصميم | أخضر: lint و10 Unit وبناء Vite واختبارا Playwright مستهدفان وDocker؛ RTL/LTR والوضع الداكن والفوتر و320px بلا overflow أو طلب خارجي، وCSP `self` وتراخيص الخط والأيقونات ضمن الصورة؛ تحديث بصري بلا تغيير عقد أو بدء W1.2 |
