...
- الموجة المنجزة محلياً: **W1.2 Organization + Identity + Import** — `main@e6235b76`
  متقدم 24 التزاماً على `origin/main@f3bca710`، و`make verify-w1-2` أخضر محلياً.
  CI التاريخي أخضر على revision السابقة `4824a804`؛ التغييرات المحلية الإضافية تحتاج
  إلى CI بعيد جديد بعد الدفع.
...
لا يغطي CI التاريخي على `4824a804` التغييرات المحلية الإضافية في `main@e6235b76`؛
يلزم CI بعيد جديد بعد الدفع. لا يبدأ أي تشغيل على الخادم حتى تصل الخطة إلى `D1`
