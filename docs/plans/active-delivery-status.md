...
- تنفيذ سلوك W1.2 لم يبدأ بعد. الخطوة التالية أول شريحة Organization رأسية للتجمع
  الواحد والمنشآت، باختبارات قبول حمراء ثم تنفيذ أخضر.
...
1. تبدأ شريحة Organization الأولى: migration وDomain وAPI للتجمع الواحد والمنشآت.
2. تكتب اختبارات `TEST-R1-W1.2-01` و`TEST-R1-W1.2-07` حمراء ثم ينفذ أصغر تغيير يخضرها.
3. بعد استقرار المنشآت تبدأ شجرة الوحدات والمناصب، ثم Person وIdentity والاستيراد.
