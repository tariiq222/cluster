...
This inventory documents 151 live `Route::` declarations plus the bootstrap health route.
...
- **Summary (EN / AR):** Retrieve audit/events. `{{AR:get_api_v1_audit_events}}`
- **Operation key:** `get_api_v1_audit_events`
- **Middleware chain:** `identity_session → require_identity_session_principal`
- **CSRF required:** `no`
- **RBAC row:** [`api-v1-audit-events:get:listauditeventscontroller`](rbac-matrix.md#row-218); principal required: `yes`.
- **Request `$ref`:** `#/components/schemas/get_api_v1_audit_events_request` (schema placeholder).
- **Response `$ref`:** `#/components/schemas/get_api_v1_audit_events_response` (schema placeholder).
- **Status codes:** `400, 401, 403`.
- **Throttle:** `default / none declared`.
- **Controller FQCN:** `Modules\Audit\Features\ListAuditEvents\Http\ListAuditEventsController`.
- **Controller source:** `apps/api/Modules/Audit/Features/ListAuditEvents/Http/ListAuditEventsController.php`.
- **OpenAPI pointer:** `docs/contracts/api/openapi.yaml#paths./api/v1/audit/events.get`.
- **Route source:** `apps/api/routes/web.php:218`.

### `GET /api/v1/audit/events/{eventId}`

- **Summary (EN / AR):** Retrieve audit/events/{eventId}. `{{AR:get_api_v1_audit_events_eventId}}`
- **Operation key:** `get_api_v1_audit_events_eventId`
- **Middleware chain:** `identity_session → require_identity_session_principal`
- **CSRF required:** `no`
- **RBAC row:** [`api-v1-audit-events-eventId:get:getauditeventcontroller`](rbac-matrix.md#row-219); principal required: `yes`.
- **Request `$ref`:** `#/components/schemas/get_api_v1_audit_events_eventId_request` (schema placeholder).
- **Response `$ref`:** `#/components/schemas/get_api_v1_audit_events_eventId_response` (schema placeholder).
- **Status codes:** `400, 401`.
- **Throttle:** `default / none declared`.
- **Controller FQCN:** `Modules\Audit\Features\GetAuditEvent\Http\GetAuditEventController`.
- **Controller source:** `apps/api/Modules/Audit/Features/GetAuditEvent/Http/GetAuditEventController.php`.
- **OpenAPI pointer:** `docs/contracts/api/openapi.yaml#paths./api/v1/audit/events/{eventId}.get`.
- **Route source:** `apps/api/routes/web.php:219`.

### `GET /api/v1/audit/exports/{exportId}`

- **Summary (EN / AR):** Retrieve audit/exports/{exportId}. `{{AR:get_api_v1_audit_exports_exportId}}`
- **Operation key:** `get_api_v1_audit_exports_exportId`
- **Middleware chain:** `identity_session → require_identity_session_principal`
- **CSRF required:** `no`
- **RBAC row:** [`api-v1-audit-exports-exportId:get:getauditexportcontroller`](rbac-matrix.md#row-220); principal required: `yes`.
- **Request `$ref`:** `#/components/schemas/get_api_v1_audit_exports_exportId_request` (schema placeholder).
- **Response `$ref`:** `#/components/schemas/get_api_v1_audit_exports_exportId_response` (schema placeholder).
- **Status codes:** `400, 401, 404`.
- **Throttle:** `default / none declared`.
- **Controller FQCN:** `Modules\Audit\Features\GetAuditExport\Http\GetAuditExportController`.
- **Controller source:** `apps/api/Modules/Audit/Features/GetAuditExport/Http/GetAuditExportController.php`.
- **OpenAPI pointer:** `docs/contracts/api/openapi.yaml#paths./api/v1/audit/exports/{exportId}.get`.
- **Route source:** `apps/api/routes/web.php:220`.

### `GET /api/v1/audit/exports/{exportId}/download`

- **Summary (EN / AR):** Retrieve audit/exports/{exportId}/download. `{{AR:get_api_v1_audit_exports_exportId_download}}`
- **Operation key:** `get_api_v1_audit_exports_exportId_download`
- **Middleware chain:** `identity_session → require_identity_session_principal`
- **CSRF required:** `no`
- **RBAC row:** [`api-v1-audit-exports-exportId-download:get:downloadauditexportcontroller`](rbac-matrix.md#row-221); principal required: `yes`.
- **Request `$ref`:** `#/components/schemas/get_api_v1_audit_exports_exportId_download_request` (schema placeholder).
- **Response `$ref`:** `#/components/schemas/get_api_v1_audit_exports_exportId_download_response` (schema placeholder).
- **Status codes:** `400`.
- **Throttle:** `default / none declared`.
- **Controller FQCN:** `Modules\Audit\Features\DownloadAuditExport\Http\DownloadAuditExportController`.
- **Controller source:** `apps/api/Modules/Audit/Features/DownloadAuditExport/Http/DownloadAuditExportController.php`.
- **OpenAPI pointer:** `docs/contracts/api/openapi.yaml#paths./api/v1/audit/exports/{exportId}/download.get`.
- **Route source:** `apps/api/routes/web.php:221`.

### `POST /api/v1/audit/exports`

- **Summary (EN / AR):** Create or execute audit/exports. `{{AR:post_api_v1_audit_exports}}`
- **Operation key:** `post_api_v1_audit_exports`
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-audit-exports:post:createauditexportcontroller`](rbac-matrix.md#row-244); principal required: `yes`.
- **Request `$ref`:** `#/components/schemas/post_api_v1_audit_exports_request` (schema placeholder).
- **Response `$ref`:** `#/components/schemas/post_api_v1_audit_exports_response` (schema placeholder).
- **Status codes:** `400, 401, 403, 409, 422`.
- **Throttle:** `default / none declared`.
- **Controller FQCN:** `Modules\Audit\Features\CreateAuditExport\Http\CreateAuditExportController`.
- **Controller source:** `apps/api/Modules/Audit/Features/CreateAuditExport/Http/CreateAuditExportController.php`.
- **OpenAPI pointer:** `docs/contracts/api/openapi.yaml#paths./api/v1/audit/exports.post`.
- **Route source:** `apps/api/routes/web.php:244`.

### `POST /api/v1/audit/integrity-verifications`

- **Summary (EN / AR):** Create or execute audit/integrity verifications. `{{AR:post_api_v1_audit_integrity_verifications}}`
- **Operation key:** `post_api_v1_audit_integrity_verifications`
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-audit-integrity-verifications:post:verifyauditintegritycontroller`](rbac-matrix.md#row-245); principal required: `yes`.
- **Request `$ref`:** `#/components/schemas/post_api_v1_audit_integrity_verifications_request` (schema placeholder).
- **Response `$ref`:** `#/components/schemas/post_api_v1_audit_integrity_verifications_response` (schema placeholder).
- **Status codes:** `400, 401, 403, 409, 422, 503`.
- **Throttle:** `default / none declared`.
- **Controller FQCN:** `Modules\Audit\Features\VerifyAuditIntegrity\Http\VerifyAuditIntegrityController`.
- **Controller source:** `apps/api/Modules/Audit/Features/VerifyAuditIntegrity/Http/VerifyAuditIntegrityController.php`.
- **OpenAPI pointer:** `docs/contracts/api/openapi.yaml#paths./api/v1/audit/integrity-verifications.post`.
- **Route source:** `apps/api/routes/web.php:245`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal`
- **CSRF required:** `no`
- **RBAC row:** [`api-v1-authorization-access-decisions-decisionId-explanation:get:explainaccessdecisioncontroller`](rbac-matrix.md#row-233); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal`
- **CSRF required:** `no`
- **RBAC row:** [`api-v1-authorization-bootstrap:get:getauthorizationbootstrapcontroller`](rbac-matrix.md#row-234); principal required: `yes`.
...
### `GET /api/v1/authorization/assignment-scope-targets`

- **Summary (EN / AR):** Retrieve authorization/assignment scope targets. `{{AR:get_api_v1_authorization_assignment_scope_targets}}`
- **Operation key:** `get_api_v1_authorization_assignment_scope_targets`
- **Middleware chain:** `identity_session → require_identity_session_principal`
- **CSRF required:** `no`
- **RBAC row:** [`api-v1-authorization-assignment-scope-targets:get:listassignmentscopetargetscontroller`](rbac-matrix.md#row-235); principal required: `yes`.
- **Request `$ref`:** `#/components/schemas/get_api_v1_authorization_assignment_scope_targets_request` (schema placeholder).
- **Response `$ref`:** `#/components/schemas/get_api_v1_authorization_assignment_scope_targets_response` (schema placeholder).
- **Status codes:** `400, 401, 403, 422`.
- **Throttle:** `default / none declared`.
- **Controller FQCN:** `Modules\Authorization\Features\Administration\Http\ListAssignmentScopeTargetsController`.
- **Controller source:** `apps/api/Modules/Authorization/Features/Administration/Http/ListAssignmentScopeTargetsController.php`.
- **OpenAPI pointer:** `docs/contracts/api/openapi.yaml#paths./api/v1/authorization/assignment-scope-targets.get`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal`
- **CSRF required:** `no`
- **RBAC row:** [`api-v1-authorization-adminResource:get:authorizationadmincontroller`](rbac-matrix.md#row-236); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal`
- **CSRF required:** `no`
- **RBAC row:** [`api-v1-authorization-adminResource-resourceId:get:authorizationadmincontroller`](rbac-matrix.md#row-237); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-authorization-access-decisions:post:decideaccesscontroller`](rbac-matrix.md#row-270); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-authorization-bootstrap-complete:post:completeauthorizationbootstrapcontroller`](rbac-matrix.md#row-271); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-authorization-adminResource:post:authorizationadmincontroller`](rbac-matrix.md#row-272); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-authorization-adminResource-resourceId:patch:authorizationadmincontroller`](rbac-matrix.md#row-273); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-authorization-adminResource-resourceId-authorizationAction:post:authorizationadmincontroller`](rbac-matrix.md#row-274); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal`
- **CSRF required:** `no`
- **RBAC row:** [`api-v1-documents-uploads-uploadId:get:getdocumentuploadstatuscontroller`](rbac-matrix.md#row-144); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal`
- **CSRF required:** `no`
- **RBAC row:** [`api-v1-documents-documentId-download:get:downloaddocumentcontroller`](rbac-matrix.md#row-145); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-documents-uploads:post:initiatedocumentuploadcontroller`](rbac-matrix.md#row-154); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-documents-uploads-uploadId-complete:post:completedocumentuploadcontroller`](rbac-matrix.md#row-155); principal required: `yes`.
...
- **Route source:** `apps/api/routes/web.php:155`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal`
- **CSRF required:** `no`
- **RBAC row:** [`api-v1-documents:get:listdocumentscontroller`](rbac-matrix.md#row-290); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal`
- **CSRF required:** `no`
- **RBAC row:** [`api-v1-documents-documentId:get:getdocumentcontroller`](rbac-matrix.md#row-291); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal`
- **CSRF required:** `no`
- **RBAC row:** [`api-v1-documents-documentId-versions:get:listdocumentversionscontroller`](rbac-matrix.md#row-292); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal`
- **CSRF required:** `no`
- **RBAC row:** [`api-v1-documents-documentId-links:get:listdocumentlinkscontroller`](rbac-matrix.md#row-293); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-documents:post:createdocumentcontroller`](rbac-matrix.md#row-319); principal required: `yes`.
...
- **Route source:** `apps/api/routes/web.php:319`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-documents-documentId:patch:updatedocumentcontroller`](rbac-matrix.md#row-320); principal required: `yes`.
...
- **Route source:** `apps/api/routes/web.php:320`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-documents-documentId-versions:post:adddocumentversioncontroller`](rbac-matrix.md#row-321); principal required: `yes`.
...
- **Route source:** `apps/api/routes/web.php:321`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-documents-documentId-links:post:documentlinkcontroller`](rbac-matrix.md#row-322); principal required: `yes`.
...
- **Route source:** `apps/api/routes/web.php:322`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-documents-documentId-documentAction:post:transitiondocumentcontroller`](rbac-matrix.md#row-323); principal required: `yes`.
...
- **Route source:** `apps/api/routes/web.php:323`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-documents-documentId-documentGrantType-grant:post:createdocumentgrantcontroller`](rbac-matrix.md#row-324); principal required: `yes`.
...
- **Route source:** `apps/api/routes/web.php:324`.
...
- **CSRF required:** `no`
- **RBAC row:** [`api-v1-auth-login:post:developmentfixturelogincontroller`](rbac-matrix.md#row-124); principal required: `no`.
...
- **CSRF required:** `no`
- **RBAC row:** [`api-v1-identity-login:post:identitylogincontroller`](rbac-matrix.md#row-127); principal required: `no`.
...
- **Route source:** `apps/api/routes/web.php:127`.
...
- **CSRF required:** `no`
- **RBAC row:** [`api-v1-identity-activation:post:consumeactivationcontroller`](rbac-matrix.md#row-128); principal required: `no`.
...
- **Route source:** `apps/api/routes/web.php:128`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal`
- **CSRF required:** `no`
- **RBAC row:** [`api-v1-identity-me:get:getcurrentidentitycontroller`](rbac-matrix.md#row-129); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal`
- **CSRF required:** `no`
- **RBAC row:** [`api-v1-identity-csrf:post:refreshidentitycsrfcontroller`](rbac-matrix.md#row-130); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal`
- **CSRF required:** `no`
- **RBAC row:** [`api-v1-me:get:getcurrentprincipalcontroller`](rbac-matrix.md#row-131); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal`
- **CSRF required:** `no`
- **RBAC row:** [`api-v1-me-scopes:get:listmyscopescontroller`](rbac-matrix.md#row-132); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-me-scope:put:selectmyscopecontroller`](rbac-matrix.md#row-133); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-identity-logout:post:identitylogoutcontroller`](rbac-matrix.md#row-139); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-identity-password:post:changepasswordcontroller`](rbac-matrix.md#row-140); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-identity-accounts-accountId-activation:post:issueactivationcontroller`](rbac-matrix.md#row-141); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal`
- **CSRF required:** `no`
- **RBAC row:** [`api-v1-identity-accounts:get:listuseraccountscontroller`](rbac-matrix.md#row-212); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-identity-accounts:post:createuseraccountcontroller`](rbac-matrix.md#row-213); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal`
- **CSRF required:** `no`
- **RBAC row:** [`api-v1-identity-accounts-accountId:get:getuseraccountcontroller`](rbac-matrix.md#row-214); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-identity-accounts-accountId-accountAction:post:transitionuseraccountcontroller`](rbac-matrix.md#row-215); principal required: `yes`.
...
- **Middleware chain:** `throttle:60,1`
- **CSRF required:** `no`
- **RBAC row:** [`api-v1-internal-documents-versions-versionId-scan:post:scandocumentversioncontroller`](rbac-matrix.md#row-159); principal required: `no`.
...
- **Middleware chain:** `throttle:60,1`
- **CSRF required:** `no`
- **RBAC row:** [`api-v1-internal-documents-versions-versionId-reconcile-promotion:post:reconciledocumentpromotioncontroller`](rbac-matrix.md#row-160); principal required: `no`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal`
- **CSRF required:** `no`
- **RBAC row:** [`api-v1-notifications:get:listmynotificationscontroller`](rbac-matrix.md#row-162); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-notifications-notificationId-read:post:marknotificationreadcontroller`](rbac-matrix.md#row-163); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal`
- **CSRF required:** `no`
- **RBAC row:** [`api-v1-organization-temporary-assignments:get:listtemporaryassignmentscontroller`](rbac-matrix.md#row-146); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal`
- **CSRF required:** `no`
- **RBAC row:** [`api-v1-organization-temporary-assignments-temporaryAssignmentId:get:gettemporaryassignmentcontroller`](rbac-matrix.md#row-147); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-organization-temporary-assignments:post:createtemporaryassignmentcontroller`](rbac-matrix.md#row-156); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-organization-temporary-assignments-temporaryAssignmentId-revoke:post:revoketemporaryassignmentcontroller`](rbac-matrix.md#row-157); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal`
- **CSRF required:** `no`
- **RBAC row:** [`api-v1-organization-cluster:get:getclustercontroller`](rbac-matrix.md#row-179); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-organization-cluster:post:createclustercontroller`](rbac-matrix.md#row-180); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-organization-cluster:patch:updateclustercontroller`](rbac-matrix.md#row-181); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal`
- **CSRF required:** `no`
- **RBAC row:** [`api-v1-organization-facilities:get:listfacilitiescontroller`](rbac-matrix.md#row-182); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-organization-facilities:post:createfacilitycontroller`](rbac-matrix.md#row-183); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal`
- **CSRF required:** `no`
- **RBAC row:** [`api-v1-organization-facilities-facilityId:get:getfacilitycontroller`](rbac-matrix.md#row-184); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-organization-facilities-facilityId:patch:updatefacilitycontroller`](rbac-matrix.md#row-185); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal`
- **CSRF required:** `no`
- **RBAC row:** [`api-v1-organization-units:get:listorganizationunitscontroller`](rbac-matrix.md#row-186); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-organization-units:post:createorganizationunitcontroller`](rbac-matrix.md#row-187); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-organization-units-reorder:post:reorderorganizationunitscontroller`](rbac-matrix.md#row-188); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal`
- **CSRF required:** `no`
- **RBAC row:** [`api-v1-organization-units-unitId:get:getorganizationunitcontroller`](rbac-matrix.md#row-189); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-organization-units-unitId:patch:updateorganizationunitcontroller`](rbac-matrix.md#row-190); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal`
- **CSRF required:** `no`
- **RBAC row:** [`api-v1-organization-job-titles:get:listjobtitlescontroller`](rbac-matrix.md#row-191); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-organization-job-titles:post:createjobtitlecontroller`](rbac-matrix.md#row-192); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal`
- **CSRF required:** `no`
- **RBAC row:** [`api-v1-organization-positions:get:listpositionscontroller`](rbac-matrix.md#row-193); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-organization-positions:post:createpositioncontroller`](rbac-matrix.md#row-194); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal`
- **CSRF required:** `no`
- **RBAC row:** [`api-v1-organization-positions-positionId:get:getpositioncontroller`](rbac-matrix.md#row-195); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-organization-positions-positionId:patch:updatepositioncontroller`](rbac-matrix.md#row-196); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-organization-people:post:createpersoncontroller`](rbac-matrix.md#row-198); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal`
- **CSRF required:** `no`
- **RBAC row:** [`api-v1-organization-assignments:get:listassignmentscontroller`](rbac-matrix.md#row-202); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-organization-assignments:post:createassignmentcontroller`](rbac-matrix.md#row-203); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-organization-assignments-assignmentId-end:post:endassignmentcontroller`](rbac-matrix.md#row-204); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal`
- **CSRF required:** `no`
- **RBAC row:** [`api-v1-organization-supervisory-relationships:get:supervisoryrelationshipcontroller`](rbac-matrix.md#row-205); principal required: `yes`.
...
- **Route source:** `apps/api/routes/web.php:205`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-organization-supervisory-relationships:post:supervisoryrelationshipcontroller`](rbac-matrix.md#row-206); principal required: `yes`.
...
- **Summary (EN / AR):** Create or execute organization/import files. `{{AR:post_api_v1_organization_import_files}}`
- **Operation key:** `post_api_v1_organization_import_files`
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-organization-import-files:post:uploadimportfilecontroller`](rbac-matrix.md#row-207); principal required: `yes`.
- **Request `$ref`:** `#/components/schemas/post_api_v1_organization_import_files_request` (schema placeholder).
- **Response `$ref`:** `#/components/schemas/post_api_v1_organization_import_files_response` (schema placeholder).
- **Status codes:** `400, 401, 403`.
- **Throttle:** `default / none declared`.
- **Controller FQCN:** `Modules\Organization\Features\ImportFile\Http\UploadImportFileController`.
- **Controller source:** `apps/api/Modules/Organization/Features/ImportFile/Http/UploadImportFileController.php`.
- **OpenAPI pointer:** `docs/contracts/api/openapi.yaml#paths./api/v1/organization/import-files.post`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-organization-import-jobs:post:submitimportjobcontroller`](rbac-matrix.md#row-208); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal`
- **CSRF required:** `no`
- **RBAC row:** [`api-v1-organization-import-jobs-jobId:get:getimportjobcontroller`](rbac-matrix.md#row-209); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal`
- **CSRF required:** `no`
- **RBAC row:** [`api-v1-organization-import-jobs-jobId-rows:get:listimportjobrowscontroller`](rbac-matrix.md#row-210); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-organization-import-jobs-jobId-jobAction:post:transitionimportjobcontroller`](rbac-matrix.md#row-211); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal`
- **CSRF required:** `no`
- **RBAC row:** [`api-v1-platform-operations-maintenance-windows-index:get:maintenancewindowscontroller::index`](rbac-matrix.md#row-223); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal`
- **CSRF required:** `no`
- **RBAC row:** [`api-v1-platform-operations-alert-policies-index:get:alertpoliciescontroller::index`](rbac-matrix.md#row-224); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal`
- **CSRF required:** `no`
- **RBAC row:** [`api-v1-platform-operations-technical-logs-index:get:technicallogscontroller::index`](rbac-matrix.md#row-225); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal`
- **CSRF required:** `no`
- **RBAC row:** [`api-v1-platform-operations-overview:get:getplatformoverviewcontroller`](rbac-matrix.md#row-228); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal`
- **CSRF required:** `no`
- **RBAC row:** [`api-v1-platform-operations-health-health:get:platformoperationscontroller::health`](rbac-matrix.md#row-229); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal`
- **CSRF required:** `no`
- **RBAC row:** [`api-v1-platform-operations-backups-backups:get:platformoperationscontroller::backups`](rbac-matrix.md#row-230); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-platform-operations-backups:post:dispatchbackupcontroller`](rbac-matrix.md#row-254); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-platform-operations-restore-requests-requestrestore:post:platformoperationscontroller::requestrestore`](rbac-matrix.md#row-255); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-platform-operations-restore-requests-requestId-confirm-confirmrestore:post:platformoperationscontroller::confirmrestore`](rbac-matrix.md#row-256); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-platform-operations-maintenance-windows-store:post:maintenancewindowscontroller::store`](rbac-matrix.md#row-257); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-platform-operations-maintenance-windows-windowId-cancel-cancel:post:maintenancewindowscontroller::cancel`](rbac-matrix.md#row-258); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-platform-operations-alert-policies-policyId-update:patch:alertpoliciescontroller::update`](rbac-matrix.md#row-259); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-platform-operations-technical-logs-restore-restore:post:technicallogscontroller::restore`](rbac-matrix.md#row-260); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal`
- **CSRF required:** `no`
- **RBAC row:** [`api-v1-platform-settings-current:get:getcurrentplatformsettingscontroller`](rbac-matrix.md#row-222); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal`
- **CSRF required:** `no`
- **RBAC row:** [`api-v1-platform-settings-versions:get:listsettingsversionscontroller`](rbac-matrix.md#row-226); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal`
- **CSRF required:** `no`
- **RBAC row:** [`api-v1-platform-settings-calendars-index:get:businesscalendarcontroller::index`](rbac-matrix.md#row-227); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-platform-settings-versions:post:createsettingsversioncontroller`](rbac-matrix.md#row-246); principal required: `yes`.
...
- **Route source:** `apps/api/routes/web.php:246`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-platform-settings-versions-versionId-settings-settingKey:put:updatesettingsvaluecontroller`](rbac-matrix.md#row-247); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-platform-settings-versions-versionId-validate:post:validatesettingsversioncontroller`](rbac-matrix.md#row-248); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-platform-settings-versions-versionId-publish:post:publishsettingsversioncontroller`](rbac-matrix.md#row-249); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-platform-settings-calendars-store:post:businesscalendarcontroller::store`](rbac-matrix.md#row-250); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-platform-settings-calendars-calendarId-weekdays-weekday-setweekday:put:businesscalendarcontroller::setweekday`](rbac-matrix.md#row-251); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-platform-settings-calendars-calendarId-exceptions-date-setexception:put:businesscalendarcontroller::setexception`](rbac-matrix.md#row-252); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-platform-settings-calendars-calendarId-publish-publish:post:businesscalendarcontroller::publish`](rbac-matrix.md#row-253); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal`
- **CSRF required:** `no`
- **RBAC row:** [`api-v1-reports-reportId:get:getreportcontroller`](rbac-matrix.md#row-167); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal`
- **CSRF required:** `no`
- **RBAC row:** [`api-v1-exports-exportId:get:downloadexportcontroller`](rbac-matrix.md#row-168); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal`
- **CSRF required:** `no`
- **RBAC row:** [`api-v1-dashboards-dashboardId:get:getdashboardcontroller`](rbac-matrix.md#row-169); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-reports-reportId-exports:post:createreportexportcontroller`](rbac-matrix.md#row-176); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal`
- **CSRF required:** `no`
- **RBAC row:** [`api-v1-reports:get:listreportscontroller`](rbac-matrix.md#row-294); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal`
- **CSRF required:** `no`
- **RBAC row:** [`api-v1-dashboards:get:listdashboardscontroller`](rbac-matrix.md#row-295); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal`
- **CSRF required:** `no`
- **RBAC row:** [`api-v1-search:get:searchcontroller`](rbac-matrix.md#row-164); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal`
- **CSRF required:** `no`
- **RBAC row:** [`api-v1-tasks-index:get:taskcontroller::index`](rbac-matrix.md#row-287); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal`
- **CSRF required:** `no`
- **RBAC row:** [`api-v1-tasks-taskId-comments-listcomments:get:taskengagementcontroller::listcomments`](rbac-matrix.md#row-288); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal`
- **CSRF required:** `no`
- **RBAC row:** [`api-v1-tasks-taskId-show:get:taskcontroller::show`](rbac-matrix.md#row-289); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-tasks-store:post:taskcontroller::store`](rbac-matrix.md#row-309); principal required: `yes`.
...
- **Route source:** `apps/api/routes/web.php:309`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-tasks-taskId-update:patch:taskcontroller::update`](rbac-matrix.md#row-310); principal required: `yes`.
...
- **Route source:** `apps/api/routes/web.php:310`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-tasks-taskId-participants-addparticipant:post:taskengagementcontroller::addparticipant`](rbac-matrix.md#row-312); principal required: `yes`.
...
- **Route source:** `apps/api/routes/web.php:312`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-tasks-taskId-comments-addcomment:post:taskengagementcontroller::addcomment`](rbac-matrix.md#row-313); principal required: `yes`.
...
- **Route source:** `apps/api/routes/web.php:313`.

### `POST /api/v1/tasks/{taskId}/documents`

- **Summary (EN / AR):** Create or execute tasks/{taskId}/documents. `{{AR:post_api_v1_tasks_taskId_documents}}`
- **Operation key:** `post_api_v1_tasks_taskId_documents`
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-tasks-taskId-documents-attach:post:taskdocumentcontroller::attach`](rbac-matrix.md#row-314); principal required: `yes`.
- **Request `$ref`:** `#/components/schemas/post_api_v1_tasks_taskId_documents_request` (schema placeholder).
- **Response `$ref`:** `#/components/schemas/post_api_v1_tasks_taskId_documents_response` (schema placeholder).
- **Status codes:** `201, 400, 401, 403, 404, 409, 422`.
- **Throttle:** `default / none declared`.
- **Controller FQCN:** `Modules\Tasks\Features\DocumentLink\Http\TaskDocumentController::attach`.
- **Controller source:** `apps/api/Modules/Tasks/Features/DocumentLink/Http/TaskDocumentController.php::attach`.
- **OpenAPI pointer:** `docs/contracts/api/openapi.yaml#paths./api/v1/tasks/{taskId}/documents.post`.
- **Route source:** `apps/api/routes/web.php:314`.

### `POST /api/v1/tasks/{taskId}/{taskAction}`

- **Summary (EN / AR):** Create or execute tasks/{taskId}/{taskAction}. `{{AR:post_api_v1_tasks_taskId_taskAction}}`
- **Operation key:** `post_api_v1_tasks_taskId_taskAction`
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-tasks-taskId-taskAction-transition:post:taskcontroller::transition`](rbac-matrix.md#row-315); principal required: `yes`.
- **Request `$ref`:** `#/components/schemas/post_api_v1_tasks_taskId_taskAction_request` (schema placeholder).
- **Response `$ref`:** `#/components/schemas/post_api_v1_tasks_taskId_taskAction_response` (schema placeholder).
- **Status codes:** `200, 201, 400, 401, 403, 404, 409, 412, 422`.
- **Throttle:** `default / none declared`.
...
- **OpenAPI pointer:** `docs/contracts/api/openapi.yaml#paths./api/v1/tasks/{taskId}/{taskAction}.post`.
- **Route source:** `apps/api/routes/web.php:315`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → enforce_work_management_feature`
- **CSRF required:** `no`
- **RBAC row:** [`api-v1-work-definition-versions-versionId-showversionroute:get:workdefinitioncontroller::showversionroute`](rbac-matrix.md#row-280); principal required: `yes`.
...
- **Route source:** `apps/api/routes/web.php:280`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf → enforce_work_management_feature`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-work-definition-versions-versionId-versionAction-transition:post:workdefinitioncontroller::transition`](rbac-matrix.md#row-304); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → enforce_work_management_feature`
- **CSRF required:** `no`
- **RBAC row:** [`api-v1-work-definitions-index:get:workdefinitioncontroller::index`](rbac-matrix.md#row-277); principal required: `yes`.
...
- **Route source:** `apps/api/routes/web.php:277`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → enforce_work_management_feature`
- **CSRF required:** `no`
- **RBAC row:** [`api-v1-work-definitions-definitionId-show:get:workdefinitioncontroller::show`](rbac-matrix.md#row-278); principal required: `yes`.
...
- **Route source:** `apps/api/routes/web.php:278`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → enforce_work_management_feature`
- **CSRF required:** `no`
- **RBAC row:** [`api-v1-work-definitions-definitionId-versions-versions:get:workdefinitioncontroller::versions`](rbac-matrix.md#row-279); principal required: `yes`.
...
- **Route source:** `apps/api/routes/web.php:279`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf → enforce_work_management_feature`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-work-definitions-store:post:workdefinitioncontroller::store`](rbac-matrix.md#row-302); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf → enforce_work_management_feature`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-work-definitions-definitionId-versions-versions:post:workdefinitioncontroller::versions`](rbac-matrix.md#row-303); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → enforce_work_management_feature`
- **CSRF required:** `no`
- **RBAC row:** [`api-v1-work-records:get:listauthorizedworkrecordscontroller`](rbac-matrix.md#row-231); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → enforce_work_management_feature`
- **CSRF required:** `no`
- **RBAC row:** [`api-v1-work-records-recordId:get:getauthorizedworkrecordcontroller`](rbac-matrix.md#row-232); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-work-records:post:submitworkrecordcontroller`](rbac-matrix.md#row-261); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf → enforce_work_management_feature → project_work_record_read_models`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-work-records-recordId-recordAction-transition:post:workrecordlifecyclecontroller::transition`](rbac-matrix.md#row-266); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf → enforce_work_management_feature`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-work-records-recordId-documents:post:workrecorddocumentlinkcontroller`](rbac-matrix.md#row-269); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → enforce_work_management_feature`
- **CSRF required:** `no`
- **RBAC row:** [`api-v1-workflow-definitions-definitions:get:workflowcontroller::definitions`](rbac-matrix.md#row-281); principal required: `yes`.
...
- **Route source:** `apps/api/routes/web.php:281`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → enforce_work_management_feature`
- **CSRF required:** `no`
- **RBAC row:** [`api-v1-workflow-definitions-definitionId-versions-versions:get:workflowcontroller::versions`](rbac-matrix.md#row-282); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → enforce_work_management_feature`
- **CSRF required:** `no`
- **RBAC row:** [`api-v1-workflow-instances-instances:get:workflowcontroller::instances`](rbac-matrix.md#row-283); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → enforce_work_management_feature`
- **CSRF required:** `no`
- **RBAC row:** [`api-v1-workflow-instances-instanceId-showinstance:get:workflowcontroller::showinstance`](rbac-matrix.md#row-284); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → enforce_work_management_feature`
- **CSRF required:** `no`
- **RBAC row:** [`api-v1-workflow-steps-listinbox:get:workflowcontroller::listinbox`](rbac-matrix.md#row-285); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → enforce_work_management_feature`
- **CSRF required:** `no`
- **RBAC row:** [`api-v1-workflow-steps-stepId-showstep:get:workflowcontroller::showstep`](rbac-matrix.md#row-286); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf → enforce_work_management_feature`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-workflow-definitions-definitions:post:workflowcontroller::definitions`](rbac-matrix.md#row-305); principal required: `yes`.
...
- **Route source:** `apps/api/routes/web.php:305`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf → enforce_work_management_feature`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-workflow-definitions-definitionId-versions-versions:post:workflowcontroller::versions`](rbac-matrix.md#row-306); principal required: `yes`.
...
- **Route source:** `apps/api/routes/web.php:306`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf → enforce_work_management_feature`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-workflow-versions-versionId-workflowLifecycleAction-publish:post:workflowcontroller::publish`](rbac-matrix.md#row-307); principal required: `yes`.
...
- **Route source:** `apps/api/routes/web.php:307`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf → enforce_work_management_feature`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-workflow-instances-instances:post:workflowcontroller::instances`](rbac-matrix.md#row-308); principal required: `yes`.
...
- **Route source:** `apps/api/routes/web.php:308`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf → enforce_work_management_feature`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-workflow-steps-stepId-decisions-decidestep:post:workflowcontroller::decidestep`](rbac-matrix.md#row-316); principal required: `yes`.
...
- **Route source:** `apps/api/routes/web.php:316`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf → enforce_work_management_feature`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-workflow-steps-stepId-stepAction-actonstep:post:workflowcontroller::actonstep`](rbac-matrix.md#row-317); principal required: `yes`.
...
- **Route source:** `apps/api/routes/web.php:317`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf → enforce_work_management_feature`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-workflow-instances-instanceId-cancel-cancelinstance:post:workflowcontroller::cancelinstance`](rbac-matrix.md#row-318); principal required: `yes`.
...
- **Route source:** `apps/api/routes/web.php:318`.
...
| GET | `/api/v1/documents/uploads/{uploadId}` | `identity_session → require_identity_session_principal` | yes | yes | no | `none` |
| GET | `/api/v1/documents/{documentId}/download` | `identity_session → require_identity_session_principal` | yes | yes | no | `none` |
| GET | `/api/v1/organization/temporary-assignments` | `identity_session → require_identity_session_principal` | yes | yes | no | `none` |
| GET | `/api/v1/organization/temporary-assignments/{temporaryAssignmentId}` | `identity_session → require_identity_session_principal` | yes | yes | no | `none` |
...
| POST | `/api/v1/internal/documents/versions/{versionId}/scan` | `throttle:60,1` | no | no | no | `60,1` |
| POST | `/api/v1/internal/documents/versions/{versionId}/reconcile-promotion` | `throttle:60,1` | no | no | no | `60,1` |
| GET | `/api/v1/notifications` | `identity_session → require_identity_session_principal` | yes | yes | no | `none` |
...
| GET | `/api/v1/search` | `identity_session → require_identity_session_principal` | yes | yes | no | `none` |
| GET | `/api/v1/reports/{reportId}` | `identity_session → require_identity_session_principal` | yes | yes | no | `none` |
| GET | `/api/v1/exports/{exportId}` | `identity_session → require_identity_session_principal` | yes | yes | no | `none` |
| GET | `/api/v1/dashboards/{dashboardId}` | `identity_session → require_identity_session_principal` | yes | yes | no | `none` |
| POST | `/api/v1/reports/{reportId}/exports` | `identity_session → require_identity_session_principal → identity_csrf` | yes | yes | yes | `none` |
| GET | `/api/v1/organization/cluster` | `identity_session → require_identity_session_principal` | yes | yes | no | `none` |
...
| GET | `/api/v1/organization/facilities` | `identity_session → require_identity_session_principal` | yes | yes | no | `none` |
| POST | `/api/v1/organization/facilities` | `identity_session → require_identity_session_principal → identity_csrf` | yes | yes | yes | `none` |
| GET | `/api/v1/organization/facilities/{facilityId}` | `identity_session → require_identity_session_principal` | yes | yes | no | `none` |
...
| GET | `/api/v1/organization/units` | `identity_session → require_identity_session_principal` | yes | yes | no | `none` |
...
| GET | `/api/v1/organization/units/{unitId}` | `identity_session → require_identity_session_principal` | yes | yes | no | `none` |
...
| GET | `/api/v1/organization/job-titles` | `identity_session → require_identity_session_principal` | yes | yes | no | `none` |
| POST | `/api/v1/organization/job-titles` | `identity_session → require_identity_session_principal → identity_csrf` | yes | yes | yes | `none` |
| GET | `/api/v1/organization/positions` | `identity_session → require_identity_session_principal` | yes | yes | no | `none` |
| POST | `/api/v1/organization/positions` | `identity_session → require_identity_session_principal → identity_csrf` | yes | yes | yes | `none` |
| GET | `/api/v1/organization/positions/{positionId}` | `identity_session → require_identity_session_principal` | yes | yes | no | `none` |
...
| GET | `/api/v1/organization/people` | `identity_session → require_identity_session_principal` | yes | yes | no | `none` |
| POST | `/api/v1/organization/people` | `identity_session → require_identity_session_principal → identity_csrf` | yes | yes | yes | `none` |
| GET | `/api/v1/organization/people/{personId}/reference` | `identity_session → require_identity_session_principal` | yes | yes | no | `none` |
| GET | `/api/v1/organization/people/{personId}` | `identity_session → require_identity_session_principal` | yes | yes | no | `none` |
...
| GET | `/api/v1/organization/assignments` | `identity_session → require_identity_session_principal` | yes | yes | no | `none` |
...
| GET | `/api/v1/organization/supervisory-relationships` | `identity_session → require_identity_session_principal` | yes | yes | no | `none` |
...
| POST | `/api/v1/organization/import-files` | `identity_session → require_identity_session_principal → identity_csrf` | yes | yes | yes | `none` |
| POST | `/api/v1/organization/import-jobs` | `identity_session → require_identity_session_principal → identity_csrf` | yes | yes | yes | `none` |
| GET | `/api/v1/organization/import-jobs/{jobId}` | `identity_session → require_identity_session_principal` | yes | yes | no | `none` |
| GET | `/api/v1/organization/import-jobs/{jobId}/rows` | `identity_session → require_identity_session_principal` | yes | yes | no | `none` |
...
| GET | `/api/v1/identity/accounts` | `identity_session → require_identity_session_principal` | yes | yes | no | `none` |
| POST | `/api/v1/identity/accounts` | `identity_session → require_identity_session_principal → identity_csrf` | yes | yes | yes | `none` |
| GET | `/api/v1/identity/accounts/{accountId}` | `identity_session → require_identity_session_principal` | yes | yes | no | `none` |
...
| GET | `/api/v1/audit/events` | `identity_session → require_identity_session_principal` | yes | yes | no | `none` |
| GET | `/api/v1/audit/events/{eventId}` | `identity_session → require_identity_session_principal` | yes | yes | no | `none` |
| GET | `/api/v1/audit/exports/{exportId}` | `identity_session → require_identity_session_principal` | yes | yes | no | `none` |
| GET | `/api/v1/audit/exports/{exportId}/download` | `identity_session → require_identity_session_principal` | yes | yes | no | `none` |
| GET | `/api/v1/platform-settings/current` | `identity_session → require_identity_session_principal` | yes | yes | no | `none` |
| GET | `/api/v1/platform-operations/maintenance-windows` | `identity_session → require_identity_session_principal` | yes | yes | no | `none` |
| GET | `/api/v1/platform-operations/alert-policies` | `identity_session → require_identity_session_principal` | yes | yes | no | `none` |
| GET | `/api/v1/platform-operations/technical-logs` | `identity_session → require_identity_session_principal` | yes | yes | no | `none` |
| GET | `/api/v1/platform-settings/versions` | `identity_session → require_identity_session_principal` | yes | yes | no | `none` |
| GET | `/api/v1/platform-settings/calendars` | `identity_session → require_identity_session_principal` | yes | yes | no | `none` |
| GET | `/api/v1/platform-operations/overview` | `identity_session → require_identity_session_principal` | yes | yes | no | `none` |
| GET | `/api/v1/platform-operations/health` | `identity_session → require_identity_session_principal` | yes | yes | no | `none` |
| GET | `/api/v1/platform-operations/backups` | `identity_session → require_identity_session_principal` | yes | yes | no | `none` |
| GET | `/api/v1/work-records` | `identity_session → require_identity_session_principal → enforce_work_management_feature` | yes | yes | no | `none` |
| GET | `/api/v1/work-records/{recordId}` | `identity_session → require_identity_session_principal → enforce_work_management_feature` | yes | yes | no | `none` |
| GET | `/api/v1/authorization/access-decisions/{decisionId}/explanation` | `identity_session → require_identity_session_principal` | yes | yes | no | `none` |
| GET | `/api/v1/authorization/bootstrap` | `identity_session → require_identity_session_principal` | yes | yes | no | `none` |
| GET | `/api/v1/authorization/assignment-scope-targets` | `identity_session → require_identity_session_principal` | yes | yes | no | `none` |
| GET | `/api/v1/authorization/{adminResource}` | `identity_session → require_identity_session_principal` | yes | yes | no | `none` |
| GET | `/api/v1/authorization/{adminResource}/{resourceId}` | `identity_session → require_identity_session_principal` | yes | yes | no | `none` |
| POST | `/api/v1/audit/exports` | `identity_session → require_identity_session_principal → identity_csrf` | yes | yes | yes | `none` |
| POST | `/api/v1/audit/integrity-verifications` | `identity_session → require_identity_session_principal → identity_csrf` | yes | yes | yes | `none` |
...
| POST | `/api/v1/work-records/{recordId}/{recordAction}` | `identity_session → require_identity_session_principal → identity_csrf → enforce_work_management_feature → project_work_record_read_models` | yes | yes | yes | `none` |
| POST | `/api/v1/work-records/{recordId}/documents` | `identity_session → require_identity_session_principal → identity_csrf → enforce_work_management_feature` | yes | yes | yes | `none` |
...
| GET | `/api/v1/work-definitions` | `identity_session → require_identity_session_principal → enforce_work_management_feature` | yes | yes | no | `none` |
| GET | `/api/v1/work-definitions/{definitionId}` | `identity_session → require_identity_session_principal → enforce_work_management_feature` | yes | yes | no | `none` |
| GET | `/api/v1/work-definitions/{definitionId}/versions` | `identity_session → require_identity_session_principal → enforce_work_management_feature` | yes | yes | no | `none` |
| GET | `/api/v1/work-definition-versions/{versionId}` | `identity_session → require_identity_session_principal → enforce_work_management_feature` | yes | yes | no | `none` |
| GET | `/api/v1/workflow/definitions` | `identity_session → require_identity_session_principal → enforce_work_management_feature` | yes | yes | no | `none` |
| GET | `/api/v1/workflow/definitions/{definitionId}/versions` | `identity_session → require_identity_session_principal → enforce_work_management_feature` | yes | yes | no | `none` |
| GET | `/api/v1/workflow/instances` | `identity_session → require_identity_session_principal → enforce_work_management_feature` | yes | yes | no | `none` |
| GET | `/api/v1/workflow/instances/{instanceId}` | `identity_session → require_identity_session_principal → enforce_work_management_feature` | yes | yes | no | `none` |
| GET | `/api/v1/workflow/steps` | `identity_session → require_identity_session_principal → enforce_work_management_feature` | yes | yes | no | `none` |
| GET | `/api/v1/workflow/steps/{stepId}` | `identity_session → require_identity_session_principal → enforce_work_management_feature` | yes | yes | no | `none` |
| GET | `/api/v1/tasks` | `identity_session → require_identity_session_principal` | yes | yes | no | `none` |
| GET | `/api/v1/tasks/{taskId}/comments` | `identity_session → require_identity_session_principal` | yes | yes | no | `none` |
| GET | `/api/v1/tasks/{taskId}` | `identity_session → require_identity_session_principal` | yes | yes | no | `none` |
| GET | `/api/v1/documents` | `identity_session → require_identity_session_principal` | yes | yes | no | `none` |
| GET | `/api/v1/documents/{documentId}` | `identity_session → require_identity_session_principal` | yes | yes | no | `none` |
| GET | `/api/v1/documents/{documentId}/versions` | `identity_session → require_identity_session_principal` | yes | yes | no | `none` |
| GET | `/api/v1/documents/{documentId}/links` | `identity_session → require_identity_session_principal` | yes | yes | no | `none` |
| GET | `/api/v1/reports` | `identity_session → require_identity_session_principal` | yes | yes | no | `none` |
| GET | `/api/v1/dashboards` | `identity_session → require_identity_session_principal` | yes | yes | no | `none` |
| POST | `/api/v1/work-definitions` | `identity_session → require_identity_session_principal → identity_csrf → enforce_work_management_feature` | yes | yes | yes | `none` |
| POST | `/api/v1/work-definitions/{definitionId}/versions` | `identity_session → require_identity_session_principal → identity_csrf → enforce_work_management_feature` | yes | yes | yes | `none` |
| POST | `/api/v1/work-definition-versions/{versionId}/{versionAction}` | `identity_session → require_identity_session_principal → identity_csrf → enforce_work_management_feature` | yes | yes | yes | `none` |
| POST | `/api/v1/workflow/definitions` | `identity_session → require_identity_session_principal → identity_csrf → enforce_work_management_feature` | yes | yes | yes | `none` |
| POST | `/api/v1/workflow/definitions/{definitionId}/versions` | `identity_session → require_identity_session_principal → identity_csrf → enforce_work_management_feature` | yes | yes | yes | `none` |
| POST | `/api/v1/workflow/versions/{versionId}/{workflowLifecycleAction}` | `identity_session → require_identity_session_principal → identity_csrf → enforce_work_management_feature` | yes | yes | yes | `none` |
| POST | `/api/v1/workflow/instances` | `identity_session → require_identity_session_principal → identity_csrf → enforce_work_management_feature` | yes | yes | yes | `none` |
...
| POST | `/api/v1/tasks/{taskId}/documents` | `identity_session → require_identity_session_principal → identity_csrf` | yes | yes | yes | `none` |
| POST | `/api/v1/tasks/{taskId}/{taskAction}` | `identity_session → require_identity_session_principal → identity_csrf` | yes | yes | yes | `none` |
| POST | `/api/v1/workflow/steps/{stepId}/decisions` | `identity_session → require_identity_session_principal → identity_csrf → enforce_work_management_feature` | yes | yes | yes | `none` |
| POST | `/api/v1/workflow/steps/{stepId}/{stepAction}` | `identity_session → require_identity_session_principal → identity_csrf → enforce_work_management_feature` | yes | yes | yes | `none` |
| POST | `/api/v1/workflow/instances/{instanceId}/cancel` | `identity_session → require_identity_session_principal → identity_csrf → enforce_work_management_feature` | yes | yes | yes | `none` |
...
- Live route declarations represented by cards: 151 / 151.
