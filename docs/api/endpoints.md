...
This inventory documents 149 live `Route::` declarations plus the bootstrap health route.
...
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-audit-events:get:listauditeventscontroller`](rbac-matrix.md#row-215); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-audit-events-eventId:get:getauditeventcontroller`](rbac-matrix.md#row-216); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-audit-exports-exportId:get:getauditexportcontroller`](rbac-matrix.md#row-217); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-audit-exports-exportId-download:get:downloadauditexportcontroller`](rbac-matrix.md#row-218); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-audit-exports:post:createauditexportcontroller`](rbac-matrix.md#row-240); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-audit-integrity-verifications:post:verifyauditintegritycontroller`](rbac-matrix.md#row-241); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-authorization-access-decisions-decisionId-explanation:get:explainaccessdecisioncontroller`](rbac-matrix.md#row-230); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-authorization-bootstrap:get:getauthorizationbootstrapcontroller`](rbac-matrix.md#row-231); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-authorization-adminResource:get:authorizationadmincontroller`](rbac-matrix.md#row-232); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-authorization-adminResource-resourceId:get:authorizationadmincontroller`](rbac-matrix.md#row-233); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-authorization-access-decisions:post:decideaccesscontroller`](rbac-matrix.md#row-266); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-authorization-bootstrap-complete:post:completeauthorizationbootstrapcontroller`](rbac-matrix.md#row-267); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-authorization-adminResource:post:authorizationadmincontroller`](rbac-matrix.md#row-268); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-authorization-adminResource-resourceId:patch:authorizationadmincontroller`](rbac-matrix.md#row-269); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-authorization-adminResource-resourceId-authorizationAction:post:authorizationadmincontroller`](rbac-matrix.md#row-270); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-documents-uploads-uploadId:get:getdocumentuploadstatuscontroller`](rbac-matrix.md#row-142); principal required: `yes`.
...
- **Route source:** `apps/api/routes/web.php:142`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-documents-documentId-download:get:downloaddocumentcontroller`](rbac-matrix.md#row-143); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-documents-uploads:post:initiatedocumentuploadcontroller`](rbac-matrix.md#row-152); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-documents-uploads-uploadId-complete:post:completedocumentuploadcontroller`](rbac-matrix.md#row-153); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-documents:get:listdocumentscontroller`](rbac-matrix.md#row-286); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-documents-documentId:get:getdocumentcontroller`](rbac-matrix.md#row-287); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-documents-documentId-versions:get:listdocumentversionscontroller`](rbac-matrix.md#row-288); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-documents-documentId-links:get:listdocumentlinkscontroller`](rbac-matrix.md#row-289); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-documents:post:createdocumentcontroller`](rbac-matrix.md#row-315); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-documents-documentId:patch:updatedocumentcontroller`](rbac-matrix.md#row-316); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-documents-documentId-versions:post:adddocumentversioncontroller`](rbac-matrix.md#row-317); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-documents-documentId-links:post:documentlinkcontroller`](rbac-matrix.md#row-318); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-documents-documentId-documentAction:post:transitiondocumentcontroller`](rbac-matrix.md#row-319); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-documents-documentId-documentGrantType-grant:post:createdocumentgrantcontroller`](rbac-matrix.md#row-320); principal required: `yes`.
...
- **CSRF required:** `no`
- **RBAC row:** [`api-v1-auth-login:post:developmentfixturelogincontroller`](rbac-matrix.md#row-122); principal required: `no`.
...
- **CSRF required:** `no`
- **RBAC row:** [`api-v1-identity-login:post:identitylogincontroller`](rbac-matrix.md#row-125); principal required: `no`.
...
- **Route source:** `apps/api/routes/web.php:125`.
...
- **CSRF required:** `no`
- **RBAC row:** [`api-v1-identity-activation:post:consumeactivationcontroller`](rbac-matrix.md#row-126); principal required: `no`.
...
- **CSRF required:** `no`
- **RBAC row:** [`api-v1-identity-me:get:getcurrentidentitycontroller`](rbac-matrix.md#row-127); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal`
- **CSRF required:** `no`
- **RBAC row:** [`api-v1-identity-csrf:post:refreshidentitycsrfcontroller`](rbac-matrix.md#row-128); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal`
- **CSRF required:** `no`
- **RBAC row:** [`api-v1-me:get:getcurrentprincipalcontroller`](rbac-matrix.md#row-129); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal`
- **CSRF required:** `no`
- **RBAC row:** [`api-v1-me-scopes:get:listmyscopescontroller`](rbac-matrix.md#row-130); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-me-scope:put:selectmyscopecontroller`](rbac-matrix.md#row-131); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-identity-logout:post:identitylogoutcontroller`](rbac-matrix.md#row-137); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-identity-password:post:changepasswordcontroller`](rbac-matrix.md#row-138); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-identity-accounts-accountId-activation:post:issueactivationcontroller`](rbac-matrix.md#row-139); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-identity-accounts:get:listuseraccountscontroller`](rbac-matrix.md#row-209); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-identity-accounts:post:createuseraccountcontroller`](rbac-matrix.md#row-210); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-identity-accounts-accountId:get:getuseraccountcontroller`](rbac-matrix.md#row-211); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-identity-accounts-accountId-accountAction:post:transitionuseraccountcontroller`](rbac-matrix.md#row-212); principal required: `yes`.
...
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-internal-documents-versions-versionId-scan:post:scandocumentversioncontroller`](rbac-matrix.md#row-157); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf → throttle:60,1`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-internal-documents-versions-versionId-reconcile-promotion:post:reconciledocumentpromotioncontroller`](rbac-matrix.md#row-158); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-notifications:get:listmynotificationscontroller`](rbac-matrix.md#row-160); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-notifications-notificationId-read:post:marknotificationreadcontroller`](rbac-matrix.md#row-161); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-organization-temporary-assignments:get:listtemporaryassignmentscontroller`](rbac-matrix.md#row-144); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-organization-temporary-assignments-temporaryAssignmentId:get:gettemporaryassignmentcontroller`](rbac-matrix.md#row-145); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-organization-temporary-assignments:post:createtemporaryassignmentcontroller`](rbac-matrix.md#row-154); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-organization-temporary-assignments-temporaryAssignmentId-revoke:post:revoketemporaryassignmentcontroller`](rbac-matrix.md#row-155); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-organization-cluster:get:getclustercontroller`](rbac-matrix.md#row-177); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-organization-cluster:post:createclustercontroller`](rbac-matrix.md#row-178); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-organization-cluster:patch:updateclustercontroller`](rbac-matrix.md#row-179); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-organization-facilities:get:listfacilitiescontroller`](rbac-matrix.md#row-180); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-organization-facilities:post:createfacilitycontroller`](rbac-matrix.md#row-181); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-organization-facilities-facilityId:get:getfacilitycontroller`](rbac-matrix.md#row-182); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-organization-facilities-facilityId:patch:updatefacilitycontroller`](rbac-matrix.md#row-183); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-organization-units:get:listorganizationunitscontroller`](rbac-matrix.md#row-184); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-organization-units:post:createorganizationunitcontroller`](rbac-matrix.md#row-185); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-organization-units-reorder:post:reorderorganizationunitscontroller`](rbac-matrix.md#row-186); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-organization-units-unitId:get:getorganizationunitcontroller`](rbac-matrix.md#row-187); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-organization-units-unitId:patch:updateorganizationunitcontroller`](rbac-matrix.md#row-188); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-organization-job-titles:get:listjobtitlescontroller`](rbac-matrix.md#row-189); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-organization-job-titles:post:createjobtitlecontroller`](rbac-matrix.md#row-190); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-organization-positions:get:listpositionscontroller`](rbac-matrix.md#row-191); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-organization-positions:post:createpositioncontroller`](rbac-matrix.md#row-192); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-organization-positions-positionId:get:getpositioncontroller`](rbac-matrix.md#row-193); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-organization-positions-positionId:patch:updatepositioncontroller`](rbac-matrix.md#row-194); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-organization-people:get:listpeoplecontroller`](rbac-matrix.md#row-195); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-organization-people:post:createpersoncontroller`](rbac-matrix.md#row-196); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-organization-people-personId-reference:get:getpersonreferencecontroller`](rbac-matrix.md#row-197); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-organization-people-personId:get:getpersoncontroller`](rbac-matrix.md#row-198); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-organization-people-personId:patch:updatepersoncontroller`](rbac-matrix.md#row-199); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-organization-assignments:get:listassignmentscontroller`](rbac-matrix.md#row-200); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-organization-assignments:post:createassignmentcontroller`](rbac-matrix.md#row-201); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-organization-assignments-assignmentId-end:post:endassignmentcontroller`](rbac-matrix.md#row-202); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-organization-supervisory-relationships:get:supervisoryrelationshipcontroller`](rbac-matrix.md#row-203); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-organization-supervisory-relationships:post:supervisoryrelationshipcontroller`](rbac-matrix.md#row-204); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-organization-import-jobs:post:submitimportjobcontroller`](rbac-matrix.md#row-205); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-organization-import-jobs-jobId:get:getimportjobcontroller`](rbac-matrix.md#row-206); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-organization-import-jobs-jobId-rows:get:listimportjobrowscontroller`](rbac-matrix.md#row-207); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-organization-import-jobs-jobId-jobAction:post:transitionimportjobcontroller`](rbac-matrix.md#row-208); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-platform-operations-maintenance-windows-index:get:maintenancewindowscontroller::index`](rbac-matrix.md#row-220); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-platform-operations-alert-policies-index:get:alertpoliciescontroller::index`](rbac-matrix.md#row-221); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-platform-operations-technical-logs-index:get:technicallogscontroller::index`](rbac-matrix.md#row-222); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-platform-operations-overview:get:getplatformoverviewcontroller`](rbac-matrix.md#row-225); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-platform-operations-health-health:get:platformoperationscontroller::health`](rbac-matrix.md#row-226); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-platform-operations-backups-backups:get:platformoperationscontroller::backups`](rbac-matrix.md#row-227); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-platform-operations-backups:post:dispatchbackupcontroller`](rbac-matrix.md#row-250); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-platform-operations-restore-requests-requestrestore:post:platformoperationscontroller::requestrestore`](rbac-matrix.md#row-251); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-platform-operations-restore-requests-requestId-confirm-confirmrestore:post:platformoperationscontroller::confirmrestore`](rbac-matrix.md#row-252); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-platform-operations-maintenance-windows-store:post:maintenancewindowscontroller::store`](rbac-matrix.md#row-253); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-platform-operations-maintenance-windows-windowId-cancel-cancel:post:maintenancewindowscontroller::cancel`](rbac-matrix.md#row-254); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-platform-operations-alert-policies-policyId-update:patch:alertpoliciescontroller::update`](rbac-matrix.md#row-255); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-platform-operations-technical-logs-restore-restore:post:technicallogscontroller::restore`](rbac-matrix.md#row-256); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-platform-settings-current:get:getcurrentplatformsettingscontroller`](rbac-matrix.md#row-219); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-platform-settings-versions:get:listsettingsversionscontroller`](rbac-matrix.md#row-223); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-platform-settings-calendars-index:get:businesscalendarcontroller::index`](rbac-matrix.md#row-224); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-platform-settings-versions:post:createsettingsversioncontroller`](rbac-matrix.md#row-242); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-platform-settings-versions-versionId-settings-settingKey:put:updatesettingsvaluecontroller`](rbac-matrix.md#row-243); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-platform-settings-versions-versionId-validate:post:validatesettingsversioncontroller`](rbac-matrix.md#row-244); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-platform-settings-versions-versionId-publish:post:publishsettingsversioncontroller`](rbac-matrix.md#row-245); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-platform-settings-calendars-store:post:businesscalendarcontroller::store`](rbac-matrix.md#row-246); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-platform-settings-calendars-calendarId-weekdays-weekday-setweekday:put:businesscalendarcontroller::setweekday`](rbac-matrix.md#row-247); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-platform-settings-calendars-calendarId-exceptions-date-setexception:put:businesscalendarcontroller::setexception`](rbac-matrix.md#row-248); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-platform-settings-calendars-calendarId-publish-publish:post:businesscalendarcontroller::publish`](rbac-matrix.md#row-249); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-reports-reportId:get:getreportcontroller`](rbac-matrix.md#row-165); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-exports-exportId:get:downloadexportcontroller`](rbac-matrix.md#row-166); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-dashboards-dashboardId:get:getdashboardcontroller`](rbac-matrix.md#row-167); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-reports-reportId-exports:post:createreportexportcontroller`](rbac-matrix.md#row-174); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-reports:get:listreportscontroller`](rbac-matrix.md#row-290); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-dashboards:get:listdashboardscontroller`](rbac-matrix.md#row-291); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-search:get:searchcontroller`](rbac-matrix.md#row-162); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-tasks-index:get:taskcontroller::index`](rbac-matrix.md#row-283); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-tasks-taskId-comments-listcomments:get:taskengagementcontroller::listcomments`](rbac-matrix.md#row-284); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-tasks-taskId-show:get:taskcontroller::show`](rbac-matrix.md#row-285); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-tasks-store:post:taskcontroller::store`](rbac-matrix.md#row-305); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-tasks-taskId-update:patch:taskcontroller::update`](rbac-matrix.md#row-306); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-tasks-taskId-participants-addparticipant:post:taskengagementcontroller::addparticipant`](rbac-matrix.md#row-308); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-tasks-taskId-comments-addcomment:post:taskengagementcontroller::addcomment`](rbac-matrix.md#row-309); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-tasks-taskId-documents-attach:post:taskdocumentcontroller::attach`](rbac-matrix.md#row-310); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-tasks-taskId-taskAction-transition:post:taskcontroller::transition`](rbac-matrix.md#row-311); principal required: `yes`.
...
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-work-definition-versions-versionId-showversionroute:get:workdefinitioncontroller::showversionroute`](rbac-matrix.md#row-276); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf → enforce_work_management_feature`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-work-definition-versions-versionId-versionAction-transition:post:workdefinitioncontroller::transition`](rbac-matrix.md#row-300); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf → enforce_work_management_feature`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-work-definitions-index:get:workdefinitioncontroller::index`](rbac-matrix.md#row-273); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf → enforce_work_management_feature`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-work-definitions-definitionId-show:get:workdefinitioncontroller::show`](rbac-matrix.md#row-274); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf → enforce_work_management_feature`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-work-definitions-definitionId-versions-versions:get:workdefinitioncontroller::versions`](rbac-matrix.md#row-275); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf → enforce_work_management_feature`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-work-definitions-store:post:workdefinitioncontroller::store`](rbac-matrix.md#row-298); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf → enforce_work_management_feature`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-work-definitions-definitionId-versions-versions:post:workdefinitioncontroller::versions`](rbac-matrix.md#row-299); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf → enforce_work_management_feature`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-work-records:get:listauthorizedworkrecordscontroller`](rbac-matrix.md#row-228); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf → enforce_work_management_feature`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-work-records-recordId:get:getauthorizedworkrecordcontroller`](rbac-matrix.md#row-229); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-work-records:post:submitworkrecordcontroller`](rbac-matrix.md#row-257); principal required: `yes`.
...
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-work-records-recordId-recordAction-transition:post:workrecordlifecyclecontroller::transition`](rbac-matrix.md#row-262); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf → enforce_work_management_feature`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-work-records-recordId-documents:post:workrecorddocumentlinkcontroller`](rbac-matrix.md#row-265); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf → enforce_work_management_feature`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-workflow-definitions-definitions:get:workflowcontroller::definitions`](rbac-matrix.md#row-277); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf → enforce_work_management_feature`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-workflow-definitions-definitionId-versions-versions:get:workflowcontroller::versions`](rbac-matrix.md#row-278); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf → enforce_work_management_feature`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-workflow-instances-instances:get:workflowcontroller::instances`](rbac-matrix.md#row-279); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf → enforce_work_management_feature`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-workflow-instances-instanceId-showinstance:get:workflowcontroller::showinstance`](rbac-matrix.md#row-280); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf → enforce_work_management_feature`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-workflow-steps-listinbox:get:workflowcontroller::listinbox`](rbac-matrix.md#row-281); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf → enforce_work_management_feature`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-workflow-steps-stepId-showstep:get:workflowcontroller::showstep`](rbac-matrix.md#row-282); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf → enforce_work_management_feature`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-workflow-definitions-definitions:post:workflowcontroller::definitions`](rbac-matrix.md#row-301); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf → enforce_work_management_feature`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-workflow-definitions-definitionId-versions-versions:post:workflowcontroller::versions`](rbac-matrix.md#row-302); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf → enforce_work_management_feature`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-workflow-versions-versionId-workflowLifecycleAction-publish:post:workflowcontroller::publish`](rbac-matrix.md#row-303); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf → enforce_work_management_feature`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-workflow-instances-instances:post:workflowcontroller::instances`](rbac-matrix.md#row-304); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf → enforce_work_management_feature`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-workflow-steps-stepId-decisions-decidestep:post:workflowcontroller::decidestep`](rbac-matrix.md#row-312); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf → enforce_work_management_feature`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-workflow-steps-stepId-stepAction-actonstep:post:workflowcontroller::actonstep`](rbac-matrix.md#row-313); principal required: `yes`.
...
- **Middleware chain:** `identity_session → require_identity_session_principal → identity_csrf → enforce_work_management_feature`
- **CSRF required:** `yes`
- **RBAC row:** [`api-v1-workflow-instances-instanceId-cancel-cancelinstance:post:workflowcontroller::cancelinstance`](rbac-matrix.md#row-314); principal required: `yes`.
...
- Live route declarations represented by cards: 149 / 149.
