...
| المعرف | المتطلب | الإصدار | المصدر | معيار القياس | التحقق |
|---|---|---|---|---|---|
| SEC-R1-001 | منع اتصال الشبكة الخارجية افتراضياً | R1 | ADR-018 | NetworkPolicy = deny-all | فحص CI |
...
| SEC-R1-011 | SBOM لكل إصدار | R1 | ADR-018 | SBOM موجود وموقّع | فحص CI |
| SEC-R1-012 | فصل النسخ الاحتياطي عن Kubernetes ومشفّر | R1 | وثيقة الرؤية §24.4 | مخزن مستقل | فحص تشغيلي |
...
| OPS-R1-004 | نسخ احتياطي مشفّر منفصل عن Kubernetes | R1 | وثيقة الرؤية §24.4 | مخزن مستقل | فحص تشغيلي |
| OPS-R1-005 | اختبار استعادة دوري موثق | R1 | وثيقة الرؤية §24.3 | اختبار شهري | سجل التشغيل |
| OPS-R1-006 | نشر تدرّجي مع إمكانية رجوع | R1 | وثيقة الرؤية §23.5 | Rolling Update | سجل النشر |
| OPS-R1-007 | فصل بيئات التطوير والاختبار والتجريب والإنتاج | R1 | وثيقة الرؤية §23.5 | فصل شبكي وملكي | فحص تشغيلي |
| OPS-R1-008 | ترقية حزم بمسار Offline موثق | R1 | وثيقة الرؤية §23.6 | سجل ترقية | سجل العمليات |
...
| OPS-R1-011 | مركزية صور الحاويات في Registry داخلي | R1 | ADR-018 | كل الصور محلية | فحص تشغيلي |
| OPS-R1-012 | مركزية Composer وnpm كمرايا داخلية | R1 | ADR-018 | لا تنزيل خارجي | فحص CI |
