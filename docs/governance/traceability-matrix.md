...
| SEC-R1-011 | SBOM مرتبط بكل صورة إصدار ثابتة مع scan/provenance وcommit | R1 | ADR-023 | تطابق SBOM مع image digest ودليل الإصدار | فحص CI |
...
| OPS-R1-006 | نشر Dokploy مع فحص صحة ورجوع | R1 | ADR-023 | رجوع إلى digest وCompose revision سابقين | سجل النشر |
| OPS-R1-007 | فصل بيانات وأسرار وvolumes الإنتاج عن Dev/Test | R1 | ADR-023 | لا مشاركة بين البيئات | فحص تشغيلي |
| OPS-R1-008 | تحديث مضبوط ثم release وrollback عبر Dokploy | R1 | ADR-023 | سجل update وrelease وrollback مكتمل | سجل العمليات |
...
| OPS-R1-011 | نشر صورة مثبتة بالـdigest وCompose revision عبر Dokploy | R1 | ADR-023 | تطابق digest وrevision مع دليل الإصدار | فحص تشغيلي |
