...
| الرقم | الافتراض | معيار التحقق | الأثر عند الانتهاك |
|---|---|---|---|
| T1 | المنصة تعمل على خادم داخلي واحد عبر Dokploy وDocker Compose، والوصول الوارد محكوم بجدار ناري | فحص المنافذ الحية وربط الخدمات | يُمنع النشر ويعاد ضبط المضيف |
...
| الرقم | الافتراض | معيار التحقق | الأثر عند الانتهاك |
|---|---|---|---|
| O1 | يوجد مشغل مسؤول عن الخادم وDokploy والنسخ والاستعادة | توافر المالك وإجراء الطوارئ | تخفف أهداف الاستعادة أو يؤجل الإنتاج |
...
| O4 | صيانة Docker وDokploy والخادم تتم في نافذة معلنة تقبل توقف الخدمة | خطة صيانة معتمدة | تُعدَّل النافذة |
...
| C2 | لا تنشر MySQL أو Valkey أو Docker socket أو إدارة Dokploy للعامة | لا استثناء | ADR-023 |
