...
> Do not re-execute. Residual operator gate: production W27 remains externally evidenced.
...
- [x] **Step 3: Correct the contract minimally**
...
- [x] **Step 3: Implement the minimal scoped path**
...
- [x] **Step 3: Implement batch label contracts and projection**
...
- [x] **Step 1: Write failing persona tests**
...
- [x] **Step 3: Implement the exact capability matrix**
...
- [x] **Step 2: Verify W27 remains externally gated**
...
- [x] **Step 3: Record the result honestly**
...
- [x] **Step 2: Implement the minimal switcher**
