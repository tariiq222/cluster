...
| الاستضافة الداخلية | يعمل المنتج على خادم Dokploy واحد، ولا تنشر خدمات الحالة أو الإدارة للعامة. | فحص منافذ المضيف وشبكات Docker وCompose وتجربة وصول سلبية. |
...
منتج البحث والتخزين وqueue/cache وإدارة الأسرار ليست محددة هنا. منصة النشر حُسمت في ADR-023 إلى Dokploy وDocker Compose على خادم داخلي واحد؛ وتبقى السعة والاستعادة والمنافذ حقائق لا تقبل إلا بدليل تشغيل.
