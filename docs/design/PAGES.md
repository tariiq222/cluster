...
**التفعيل** يولّد رمزاً لمرة واحدة — يُعرض في `Dialog` بزر نسخ وتحذير «لن يظهر مرة أخرى». لا يُطبع في قائمة ولا يُخزَّن في الحالة بعد الإغلاق.
...
| **النمط** | قائمة ← تفصيل |
| **من يراها** | `authorization.decision.explain` |
| **الطبقات** | ✅ مفعّل × 2 |
