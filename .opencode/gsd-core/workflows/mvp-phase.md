...
<required_reading>
@/Users/tariq/code/R3/cluster/.opencode/gsd-core/references/user-story-template.md
@/Users/tariq/code/R3/cluster/.opencode/gsd-core/references/spidr-splitting.md
@/Users/tariq/code/R3/cluster/.opencode/gsd-core/references/planner-mvp-mode.md
</required_reading>
...
Normalize per `@/Users/tariq/code/R3/cluster/.opencode/gsd-core/references/phase-argument-parsing.md` (zero-pad integer phases to two digits).
...
Run three sequential `question` calls. Each is free-text. After all three, assemble into the canonical sentence per `@/Users/tariq/code/R3/cluster/.opencode/gsd-core/references/user-story-template.md`:
...
Run the SPIDR rules from `@/Users/tariq/code/R3/cluster/.opencode/gsd-core/references/spidr-splitting.md`. Briefly:
