...
<required_reading>
@/Users/tariq/code/R3/cluster/.opencode/gsd-core/references/ai-frameworks.md
@/Users/tariq/code/R3/cluster/.opencode/gsd-core/references/ai-evals.md
</required_reading>
...
```markdown
Read /Users/tariq/code/R3/cluster/.opencode/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "/Users/tariq/code/R3/cluster/.opencode/gsd-core/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read /Users/tariq/code/R3/cluster/.opencode/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read /Users/tariq/code/R3/cluster/.opencode/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read /Users/tariq/code/R3/cluster/.opencode/agents/gsd-eval-planner.md for instructions.
