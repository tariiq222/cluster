...
```
Agent(
  prompt="Read /Users/tariq/code/R3/cluster/.opencode/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/tariq/code/R3/cluster/.opencode/gsd-core/templates/SECURITY.md`
