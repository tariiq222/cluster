...
ones). Reference: @/Users/tariq/code/R3/cluster/.opencode/gsd-core/references/edge-probe.md.
...
# — NOT the consuming project's git root — falling back to git toplevel / /Users/tariq/code/R3/cluster/.opencode.
...
EDGE_PROBE_JS=$(for _c in \
  ...
  "/Users/tariq/code/R3/cluster/.opencode/gsd-core/bin/lib/edge-probe.cjs" \
  "/Users/tariq/code/R3/cluster/.opencode/bin/lib/edge-probe.cjs"; do
  [ -f "$_c" ] && { echo "$_c"; break; }
done)
...
requirement list). Reference: @/Users/tariq/code/R3/cluster/.opencode/gsd-core/references/prohibition-probe.md — the
...
Use the SPEC.md template from @/Users/tariq/code/R3/cluster/.opencode/gsd-core/templates/spec.md.
