import type { AppShellCopy } from './AppShell'
...
export const text = {
  ar: {
    ...
    organizationFacilities: 'المنشآت',
    ...
    accessExplanation: 'فحص قرار الوصول',
    authorizationGroup: 'الصلاحيات والوصول',
    workflowGroup: 'سير العمل',
    workflowTasks: 'سير العمل والمهام',
    workDefinitions: 'أنواع الطلبات',
    workflowAdmin: 'مسارات الاعتماد',
    procedureOfficeReview: 'مراجعة ونشر الإجراءات',
    myTasks: 'مهامي',
    myApprovals: 'بانتظار إجراء مني',
    procedures: 'الإجراءات والخدمات',
    dashboardsScreen: 'لوحات المؤشرات',
    ...
    profile: 'ملفي',
    personalAccess: 'صلاحياتي ونطاق عملي',
    ...
    governanceAndAccess: 'الحوكمة والوصول',
    ...
    internalTools: 'الأدوات الداخلية',
  ...
  en: {
    ...
    accessExplanation: 'Access decision inspector',
    authorizationGroup: 'Access and permissions',
    workflowGroup: 'Workflow',
    workflowTasks: 'Workflow and tasks',
    workDefinitions: 'Request types',
    workflowAdmin: 'Approval paths',
    procedureOfficeReview: 'Procedure review and publish',
    myTasks: 'My tasks',
    myApprovals: 'Awaiting my action',
    procedures: 'Procedures & services',
    dashboardsScreen: 'Indicator dashboards',
    ...
    profile: 'My profile',
    personalAccess: 'My permissions and work scope',
    ...
    governanceAndAccess: 'Governance and access',
    accountsAndAccess: 'Accounts and permissions',
    coverage: 'Coverage',
    ...
    reportsAndIndicators: 'Reports and monitoring',
    enGb: 'en-GB',
    ...
    loadMore: 'Load more',
    organizationAndWorkforce: 'Facilities and employees',
...
export function shellCopy(locale: Locale): AppShellCopy {
  ...
  return {
    ...
    scopeSelectorLabel: copy.scopeSelectorLabel,
    scopeSelectorEmpty: copy.scopeSelectorEmpty,
    scopeChangePending: copy.scopeChangePending,
    scopeStale: copy.scopeStale,
    scopeRetry: copy.scopeRetry,
  }
}
