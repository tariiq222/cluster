...
export const organizationCopy = {
  ar: {
    ...
    detailsSection: 'البيانات الأساسية',
    assignmentPartiesSection: 'أطراف التكليف',
    assignmentTimingSection: 'موعد التكليف',
    reviewTitle: 'مراجعة البيانات',
    notProvided: 'لم يُدخل بعد',
    code: 'الرقم التعريفي',
    codeHint:
    ...
    unitsTitle: 'الوحدات التنظيمية',
    structureIntro:
      'وحدات التجمع والمنشآت في شجرة واحدة؛ أضف وحدة جديدة أو رتّب المستويات.',
    unitPositions: 'المناصب',
    noUnits: 'لا توجد وحدات بعد.',
    noUnitsBody: 'ابدأ بإضافة أول وحدة لبناء الهيكل التنظيمي.',
    ...
    backToStructure: 'عودة إلى الهيكل التنظيمي',
    backToFacilities: 'عودة إلى المنشآت',
    backToPositions: 'عودة إلى الوظائف',
    backToJobTitles: 'عودة إلى المسميات',
    backToPeople: 'عودة إلى الموظفين',
    backToAssignments: 'عودة إلى التكليفات',
    backToCluster: 'عودة إلى التجمع',
  },
  en: {
    title: 'Organization',
    intro:
    ...
    detailsSection: 'Basic information',
    assignmentPartiesSection: 'Assignment parties',
    assignmentTimingSection: 'Assignment timing',
    reviewTitle: 'Review information',
    notProvided: 'Not entered yet',
    code: 'Identifier',
    codeHint:
    ...
    unitsTitle: 'Organization units',
    structureIntro:
      'Cluster and facility units in one tree — add a new unit or arrange the levels.',
    unitPositions: 'Positions',
    noUnits: 'No units yet.',
    noUnitsBody: 'Add the first unit to start building the organization structure.',
    ...
    backToJobTitles: 'Back to job titles',
    backToPeople: 'Back to employees',
