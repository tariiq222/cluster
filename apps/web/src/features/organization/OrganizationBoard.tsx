...
const copy = {
  ar: {
    ...
    noUnitsBody: 'أضف إدارة أو قسمًا ليظهر هنا.',
    cardAria: (unit: OrganizationUnit) => `${unit.name_ar}، الرقم التعريفي ${unit.code}`,
    positionsShort: 'مناصب',
    childrenShort: 'وحدات فرعية',
    popupTitle: 'تفاصيل الوحدة',
    fieldCode: 'الرقم التعريفي',
    fieldNameAr: 'الاسم بالعربية',
    fieldNameEn: 'الاسم بالإنجليزية',
    fieldType: 'النوع',
    fieldStatus: 'الحالة',
    fieldDepth: 'المستوى في الهيكل',
    fieldParent: 'الموقع الأعلى',
    noParent: 'على مستوى التجمع أو المنشأة',
  ...
  en: {
    ...
    noUnitsBody: 'Add a department or section to see it here.',
    cardAria: (unit: OrganizationUnit) => `${unit.name_ar}, identifier ${unit.code}`,
    ...
    fieldType: 'Type',
    fieldStatus: 'Status',
    fieldDepth: 'Level in structure',
    fieldParent: 'Higher level',
    noParent: 'At cluster or facility level',
