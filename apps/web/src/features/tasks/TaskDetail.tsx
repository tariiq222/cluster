...
export function TaskDetail({ locale, session, taskId, scopeReady, scopeEpoch, onNavigate }: { locale: Locale; session: Session; taskId: string; scopeReady: boolean; scopeEpoch: number; onNavigate?: (path: string) => void }) {
