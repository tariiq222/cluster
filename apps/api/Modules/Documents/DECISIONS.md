...
- File scope of the T4 commit (8bab3a4): `scripts/validate-docs.sh` (carve-out block added inside the DOC_REFERENCE loop), `docs/superpowers/plans/2026-07-26-cluster-accessibility-wcag.md` (one in-prose HTML fragment example escaped), `apps/api/Modules/Documents/DECISIONS.md` (this file).
- File scope of the follow-up commits: `apps/api/tests/Feature/CiMakeSurfaceTest.php` (175da30, s9 realignment), `apps/api/Modules/Documents/DECISIONS.md` (e8e6690, post-alignment update).
