...
namespace Modules\Organization\Features\JobTitle\Http;
...
final class ListJobTitlesController
{
    ...
    public function __invoke(Request $request): JsonResponse
    {
        ...
        if ($page['next_cursor'] !== null) {
            ...
            $response->header('Link', '</api/v1/organization/job-titles?'.http_build_query([
                'cursor' => $nextCursor,
                'limit' => $limit,
