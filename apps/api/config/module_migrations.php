...
return [
    ...
    base_path('Modules/Organization/Infrastructure/Persistence/Migrations/W27RepairOrganizationJobTitles.php'),
    ...
    base_path('Modules/Identity/Infrastructure/Persistence/Migrations/ZAddIdentityMfaRequiredColumn.php'),
    ...
    base_path('Modules/Documents/Infrastructure/Persistence/Migrations/W26AddDocumentRestrictionPolicyKey.php'),
    base_path('Shared/Infrastructure/Migrations/W27RetireWorkManagement.php'),
    ...
    base_path('Modules/Tasks/Infrastructure/Persistence/Migrations/W27RemoveWorkManagementLinks.php'),
    base_path('Shared/Infrastructure/Outbox/Migrations/W28CanonicalizeTaskOutboxEventTypes.php'),
    ...
    base_path('Modules/Reporting/Infrastructure/Persistence/Migrations/W27RetainTaskReportingDefinitions.php'),
    base_path('Modules/Reporting/Infrastructure/Persistence/Migrations/ZAddReportRunIdempotency.php'),
    base_path('Modules/Reporting/Infrastructure/Persistence/Migrations/ZAddReportRunFailureState.php'),
