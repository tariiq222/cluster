...
class InventoryTranslateTest extends TestCase
{
    ...
    public function test_s6_translate_mode_replaces_every_placeholder(): void
    {
        ...
        $this->assertSame(149, substr_count($before, '{{AR:'), 'precondition: 149 placeholders expected');
        ...
        $this->assertSame(149, substr_count($after, 'ملخص'), 'every card should expose an Arabic ملخص header');
    }
    ...
    public function test_s6_translate_mode_is_idempotent(): void
    {
        ...
        $this->assertSame(149, substr_count($afterFirst, 'ملخص'), 'first run must add Arabic headers');
    ...
    public function test_s6_translate_mode_writes_summary_artifact(): void
    {
        ...
        $this->assertSame(149, $payload['endpoint_count_translated']);
    ...
    public function test_s6_existing_inventory_check_still_passes(): void
    {
        ...
        $this->assertStringContainsString('parsed=149', $output);
    }
