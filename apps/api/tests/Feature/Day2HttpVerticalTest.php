...
final class Day2HttpVerticalTest extends TestCase
{
    ...
    public function test_definition_workflow_and_task_http_vertical_is_pinned_and_idempotent(): void
    {
        ...
        $record = $this->withToken($token)->postJson('/api/v1/work-records', ['work_definition_code' => 'request', 'title' => 'Day 2 record', 'description' => 'HTTP journey'], [...$headers, 'Idempotency-Key' => 'day2-record'])->assertCreated();
