...
final class Day2HttpVerticalTest extends TestCase
{
    ...
    public function test_definition_workflow_and_task_http_vertical_is_pinned_and_idempotent(): void
    {
        ...
        $v2 = $this->withToken($token)->postJson('/api/v1/workflow/definitions/'.$workflowDefinitionId.'/versions', ['nodes' => [['key' => 'start', 'type' => 'start'], ['key' => 'review2', 'type' => 'work_item'], ['key' => 'end', 'type' => 'end']], 'transitions' => [['from' => 'start', 'to' => 'review2'], ['from' => 'review2', 'to' => 'end']], 'decision_policy' => ['default' => 'owner']], [...$headers, 'Idempotency-Key' => 'day2-flow-v2'])->assertCreated();
